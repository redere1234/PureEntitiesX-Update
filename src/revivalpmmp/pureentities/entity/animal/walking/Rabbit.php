...
class Rabbit extends WalkingAnimal implements IntfCanBreed, IntfCanInteract, IntfCanPanic{
	...
	public function getDrops() : array{
		...
		if($this->isLootDropAllowed()){
			array_push($drops, ItemFactory::getInstance()->get(Item::RABBIT_HIDE, 0, mt_rand(0, 1)));
			if($this->isOnFire()){
				array_push($drops, ItemFactory::getInstance()->get(Item::COOKED_RABBIT, 0, mt_rand(0, 1)));
			}else{
